...
$stanford_links = array(
  ...
  'bottom-links' => array(
    ...
    'privacy_policy' => l('Privacy Policy', variable_get('stanford_framework_links_privacy_policy', 'https://www.stanford.edu/site/privacy'), array('attributes' => array('title' => t('Privacy and cookie policy')))),
    'copyright' => l('Copyright Complaints', variable_get('stanford_framework_links_copyright', 'https://uit.stanford.edu/security/copyright-infringement'), array('attributes' => array('title' => t('Report alleged copyright infringement')))),
    'trademark' => l('Trademark Notice', variable_get('stanford_framework_links_trademark', 'https://adminguide.stanford.edu/chapter-1/subchapter-5/policy-1-5-4'), array('attributes' => array('title' => t('Report alleged copyright infringement')))),
